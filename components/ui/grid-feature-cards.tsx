...
const STATIC_PATTERNS: number[][][] = [
  [[7,1],[9,3],[8,5],[11,2],[10,4]],
  [[8,2],[10,1],[7,4],[9,5],[11,3]],
  [[9,1],[7,3],[10,5],[8,2],[11,4]],
  [[10,2],[8,4],[9,3],[7,5],[11,1]],
  [[7,2],[11,5],[8,1],[10,3],[9,4]],
  [[8,3],[9,2],[11,4],[7,1],[10,5]],
];

export function FeatureCard({ feature, patternIndex = 0, className, ...props }: FeatureCardProps) {
  const p = STATIC_PATTERNS[patternIndex % STATIC_PATTERNS.length];
